...
-(id)initWithDataArray:(NSMutableArray *)array{
    ...
    if (self) {
        ...
        for (int i=0; i<array.count; i++) {
            ...
            PZDflyData *data = (PZDflyData*)[array objectAtIndex:i];
...
//    [v1 setBackgroundColor:REDColor];

    //初始化第二列视图
    v2 = [[UIView alloc]initWithFrame:CGRectMake(WIDTH, 0, WIDTH, 0)];
//    [v2 setBackgroundColor:BKColor];
...
//向视图添加MessView
-(void)addMessView:(int)lValue DataInfo:(PZDflyData *)data{
       MessView *mView=nil;
    float hValue=0;
    switch (lValue) {
        case 1:
