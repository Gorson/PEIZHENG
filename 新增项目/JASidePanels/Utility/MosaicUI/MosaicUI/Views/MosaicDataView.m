...
@synthesize delegate, mosaicView, titleLabel;
...
-(UIFont *)fontWithModuleSize:(NSUInteger)aSize{
    ...
    switch (aSize) {
        ...
        case 1:
            ...
            break;
        case 2:
            retVal = [UIFont fontWithName:kMosaicDataViewFont size:16];
            break;
        case 3:
            retVal = [UIFont fontWithName:kMosaicDataViewFont size:16];
            break;
        case 4:
            retVal = [UIFont fontWithName:kMosaicDataViewFont size:24];
            break;
        case 5:
            retVal = [UIFont fontWithName:kMosaicDataViewFont size:16];
            break;
...
-(void)setModule:(MosaicData *)newModule{
    ...
    titleLabel.backgroundColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.5f];
