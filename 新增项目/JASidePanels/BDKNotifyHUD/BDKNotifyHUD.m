...
- (UIView *)backgroundView {
    ...
    _backgroundView.layer.borderWidth = 5.0f;
...
- (UILabel *)textLabel {
    ...
    CGRect frame = CGRectMake(10, floorf(CGRectGetMaxY(self.imageView.frame) + kBDKNotifyHUDDefaultInnerPadding + 10),
...
- (void)adjustTextLabel:(UILabel *)label {
    ...
    frame.size.width = self.backgroundView.frame.size.width + 50.0f;
