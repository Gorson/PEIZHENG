...
@implementation PZWebListTableCell

@synthesize headImageView;
@synthesize titleLabel, contentLabel, stateLabel;
...
//        [headImage release];
        ...
        UIButton *userButton = [self buttonWithFrame:CGRectMake(245.0f, 20.0f, 65.0f, 32.0f)];
//        userButton.backgroundColor = REDColor;
        self.acceptBtn = userButton;
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 25.0f, 180.0f, 30.0f)];
        label.backgroundColor = [UIColor clearColor];
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(240.0f, 20.0f, 65.0f, 32.0f)];
        label.backgroundColor = [UIColor clearColor];
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(35.0f, 55.0f, 200.0f, 20.0f)];
        label.backgroundColor = [UIColor clearColor];
